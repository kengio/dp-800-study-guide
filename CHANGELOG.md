...
## [1.3.0] — 2026-07-11 — Companion-exam status refresh + link repairs

Still tracking the Microsoft DP-800 blueprint dated **2026-03-12** (unaffected by this release). Corrects stale companion-certification claims in `certification/resources/companion-exams.md` that had drifted from the live Microsoft Learn pages, and repairs 24 broken external doc links found across the repo.
...
- **AI-102 retirement language converted to past tense, then updated again for its successor.** AI-102 retired **June 30, 2026** (date has now passed) — the `[!warning]` callout, the ~5-week prep-window note, the comparison-table Retirement cell, and both sequencing paths that assumed scheduling "before retirement" (Paths B and D) all still spoke in future tense. A same-day follow-up pass then discovered AI-102's actual successor, **AI-103: Azure AI Apps and Agents Developer Associate** (live, schedulable, skills measured as of April 16, 2026), and reworked every "no successor announced" / "on hold" / "watch the blog" claim across the guide (abstract, tip callout, at-a-glance table, warning callouts, prep-budget note, Paths B and D, Exam Tips, Official Documentation) to route through AI-103 instead
...
- **README.md** and **`certification/dp-800-overview.md`** — updated the two companion-exams summary lines to reflect DP-700 active/July 2026 and AI-102 retired → succeeded by AI-103, instead of the generic "retirement warning" phrasing
- **24 broken/moved external doc links repaired** across `README.md`, `TRANSLATING.md`, the hands-on labs, `official-links.md`, `renewal-guide.md`, and 17 topic files under `certification/` (docs that moved or a retired blog domain)
- **Azure SQL Service Tiers link content drift.** `official-links.md` and `certification/06-performance-optimization/01-database-configurations.md` pointed "Azure SQL Service Tiers" at `.../purchasing-models`, which Microsoft repointed to cover DTU-vs-vCore purchasing comparison rather than service tiers; repointed both to `.../service-tiers-sql-database-vcore`, the page that actually documents General Purpose/Business Critical/Hyperscale tiers
...
- **AI-103 cross-references** — study guide and cert page links added throughout `companion-exams.md` (at-a-glance table, warning callouts, Paths B/D, Exam Tips, Official Documentation)

### Verified

- All claims in this entry checked live against `learn.microsoft.com` on 2026-07-11: [DP-600 study guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/dp-600) ("Skills measured as of July 21, 2026"), [DP-700 study guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/dp-700) ("Skills measured as of July 21, 2026", Airflow workspace-settings change), [AI-102 study guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/ai-102) ("This exam was retired on June 30, 2026"), the [AI-102 cert page](https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-engineer/) ("This certification and the renewal assessment are retired"), the [AI-103 study guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/ai-103) ("Skills measured as of April 16, 2026"), the [AI-103 cert page](https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-apps-and-agents-developer-associate/) (live Schedule Exam control via Pearson VUE), and the [service tiers page](https://learn.microsoft.com/en-us/azure/azure-sql/database/service-tiers-sql-database-vcore) (200, correct topic)
...
- **Hands-on lab pack** (`certification/resources/labs/`) — 4 runnable T-SQL labs across DP-800 Domains 2–3 plus a lab-catalogue index, ~1,870 lines total: `01-vector-search-lab.md` (VECTOR type + DiskANN index + ANN-vs-ENN + metric-mismatch gotcha), `02-rag-lab.md` (chunk → embed → store → `sp_invoke_external_rest_endpoint` → parse `$.result.choices[0].message.content`), `03-fulltext-search-lab.md` (full-text catalog + CONTAINS/FREETEXT + hybrid search with RRF), `04-mcp-lab.md` (MCP server endpoint config + Copilot in Fabric / GitHub Copilot integration). Labs share a single toy product catalog so a reader can run all four against the same database
